...
export default function TripPlanner(props) {
  ...
  const handleGoClick = async () => {
    ...
    let itineraryId;
    try {
      itineraryId = await itineraryAPI.createItinerary(
        searchedCity.slug,
        verifiedUserID,
        searchedCity.image
      );
            ...
            {searchedCity ? (
                    ...
                    <CardContent>
                      ...
                      >
                        ...
                        <Rating
                          name="read-only"
                          precision={0.5}
                          value={Math.round(searchedCity.rating * 2) / 2}
                          readOnly
                        />
                        <Typography component="legend">Budget: </Typography>
                        <StyledRating
                          name="Budget"
                          value={Math.round(searchedCity.budget.value)}
                          max={10}
                          precision={0.5}
                        ...
                        <StyledRatingSafety
                          name="Safety"
                          value={Math.round(searchedCity.safety.value)}
                          max={5}
                          precision={0.5}
              ...
              <Box>
                ...
                <Typography
                  ...
                  paragraph
                >
                  Search for your dream destination and start planning your
                  itinerary now!
                </Typography>
              </Box>
            )}
